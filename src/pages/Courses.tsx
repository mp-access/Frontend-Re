...
import { FcAdvertising, FcGraduationCap } from "react-icons/fc"
  ...
  return (
    ...
    >
      <GridItem
        ...
        minW="container.sm"
      >
        <Heading pb={4} fontWeight={400} fontSize="2xl">
          {t("Welcome")}, <b>{user.given_name}</b>!
        </Heading>
        <HStack>
          ...
          {!courses.length && (
            <Center boxSize="full" color="gray.500">
              <Stack>
                ...
                <Container text-align="center" color="red">
                  Please try reloading this page if this is unexpected.
                </Container>
              </Stack>
            </Center>
          )}
