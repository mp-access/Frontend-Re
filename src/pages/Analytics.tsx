...
export default function Analytics() {
  ...
  const dataset = { data: [48, 76, 66, 81], borderColor: gradientBorder, pointRadius: 0, fill: 'start',
    tension: .1 }
  ...
  return (
      <Stack flexGrow={1} w='70%' p={6}>
        ...
        <Chart type='line' data={{ labels: ['Task 1', 'Task 2', 'Task 3', 'Task 4'], datasets: [dataset] }} options={options} />
      </Stack>
  )
}