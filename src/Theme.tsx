...
const theme = extendTheme({
  ...
  components: {
    ...
    Tag: {
      ...
      sizes: { md: { container: { px: 3, h: 6 } } },
      baseStyle: { container: { rounded: "2xl" } },
    },
    ...
    Input: {
      ...
      variants: {
        filled: {
          field: { rounded: "3xl", borderWidth: 2, borderColor: "transparent" },
        },
      },
    },
    NumberInput: {
  ...
  styles: {
    global: {
      ...
      ".cal-due": {
        ...
        fontWeight: 500,
        backgroundImage:
          "radial-gradient(var(--chakra-colors-red-400) 3px, transparent 0)",
      },
